...
const (
	...
	serverPackage  = protogen.GoImportPath("github.com/go-leo/leo/runner/net/http/server")
	errorsPackage  = protogen.GoImportPath("github.com/go-leo/errors")
)
...
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, cfg Config) {
	...
	g.P("// is compatible with the panda package it is being compiled against.")
	g.P("import  (")
...
func buildMethodDesc(g *protogen.GeneratedFile, m *protogen.Method, method, path string) *methodDesc {
	...
	headComment := ""
	cs := strings.Split(string(m.Comments.Leading), "\n")
	for _, c := range cs {
		if c == "" {
			continue
		}
	...
	if headComment != "" {
		headComment = strings.TrimSuffix(headComment, "\n")
	}
	return &methodDesc{
